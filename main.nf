...
workflow.onComplete {
    ...
    if (workflow.success) {
        log.info "-${c_purple}[lifebit-ai/smrnaseq]${c_green} Pipeline completed successfully${c_reset}-"
    } else {
        log.info "-${c_purple}[lifebit-ai/smrnaseq]${c_red} Pipeline completed with errors${c_reset}-"
    }
